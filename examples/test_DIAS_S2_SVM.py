...
from cropmaps.models import svm_train, svm_predict, save_model, LandCover_Masking
...
AOI = "/home/eouser/uth/CM_Test_SVM/AOI/AOI.geojson"
...
products_path = "/home/eouser/uth/CM_Test_SVM/eodata_local"
...
shapefile = "/home/eouser/uth/CM_Test_SVM/GT/GT_data_22-23_test.shp" # Shapefile of the vector training data
...
model = svm_train(cube_path = cube_path,
    gt_fpath = gt_data_raster, 
    results_to = "/home/eouser/uth/CM_Test_SVM",
    test_size = 0.2,
    gridsearch = True,
    parameters = {'C': [0.1, 1, 10, 100], 'gamma': ['scale', 'auto', 1], 'kernel': ['rbf']})

saved_model = save_model(model, spath = "/home/eouser/uth/CM_Test_SVM") # Save model to disk

predicted = svm_predict(cube_path = cube_path, model = model, results_to = "/home/eouser/uth/CM_Test_SVM") # Use the model to predict over the cube


landcover_data = "/home/eouser/uth/CM_Test_SVM/Landcover" # Path to store LandCover data
landcover_image = eodata.LandCover(store = landcover_data) # Download ESA worldcover data

predicted = LandCover_Masking(landcover_image, predicted, results_to = "/home/eouser/uth/CM_Test_SVM") # Mask the result using the third party LandCover product
