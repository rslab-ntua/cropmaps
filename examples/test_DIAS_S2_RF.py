...
AOI = "/home/eouser/uth/CM_Test_RF/AOI/AOI.geojson"
...
products_path = "/home/eouser/uth/CM_Test_RF/eodata_local"
...
shapefile = "/home/eouser/uth/CM_Test_RF/GT/GT_data_22-23_test.shp" # Shapefile of the vector training data
...
model = random_forest_train(cube_path = cube_path,
    ...
    results_to = "/home/eouser/uth/CM_Test_RF",
    test_size = 0.2,
    gridsearch = True,
    parameters = {'bootstrap': [True, False], 'max_depth': [10, 50, 100, None], 'max_features': ['auto', 'sqrt'], 'min_samples_leaf': [1, 2, 4], 'min_samples_split': [2, 5, 10], 'n_estimators': [100, 200, 400, 600]})
saved_model = save_model(model, spath = "/home/eouser/uth/CM_Test_RF") # Save model to disk

predicted = random_forest_predict(cube_path = cube_path, model = model, results_to = "/home/eouser/uth/CM_Test_RF") # Use the model to predict over the cube


landcover_data = "/home/eouser/uth/CM_Test_RF/Landcover" # Path to store LandCover data
landcover_image = eodata.LandCover(store = landcover_data) # Download ESA worldcover data

predicted = LandCover_Masking(landcover_image, predicted, results_to = "/home/eouser/uth/CM_Test_RF") # Mask the result using the third party LandCover product
