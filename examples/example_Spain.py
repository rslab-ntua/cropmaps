...
search = "D:\Work\Development_Projects\cropmaps\Spain\Raw"
store = "D:\Work\Development_Projects\cropmaps\Spain\eodata"
AOI = "D:\Work\Development_Projects\cropmaps\Spain\AOI\AOI.geojson"
...
products_path = "D:\Work\Development_Projects\cropmaps\Spain\eodata_local"
...
eodata.remove_orbit("51")
eodata.filter_dates("01092020", min_date = "01112019")

dates_to_remove = ["18022020", "23022020", "14032020", "29032020", "18052020", "27062020", "02072020", "07072020", "17072020", "01082020", "06082020", "26082020"]
...
bands = ["B03", "B04", "B05", "B06", "B07", "B08", "B8A", "B11", "B12", "NDVI"]
...
shapefile = "D:\Work\Development_Projects\cropmaps\Spain\GT\GT_ES_20_buffered.shp" # Shapefile of the vector training data
...
model = random_forest_train(cube_path = cube_path,
    ...
    results_to = "D:\Work\Development_Projects\cropmaps\Spain\Results")

saved_model = save_model(model, spath = "D:\Work\Development_Projects\cropmaps\Spain\Results") # Save model to disk

predicted = random_forest_predict(cube_path = cube_path, model = model, results_to = "D:\Work\Development_Projects\cropmaps\Spain\Results")

predicted = "D:\Work\Development_Projects\cropmaps\Results\Spain\Predictions.tif"

landcover_data = "D:\Work\Development_Projects\cropmaps\Results\Spain\LandCover"
landcover_image = eodata.LandCover(store = landcover_data)

predicted = LandCover_Masking(landcover_image, predicted, results_to = "D:\Work\Development_Projects\cropmaps\Spain\Results")
